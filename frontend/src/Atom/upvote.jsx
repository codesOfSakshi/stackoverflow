...
const Upvote = ({ object, upVote, downVote }) => {
    object = {upVotes:"10"}

    return (
        <div>
            { object && 
            <div class="js-voting-container d-flex jc-center fd-column ai-stretch gs4 fc-black-200" data-post-id="5963610">
            ...
            <div class="js-vote-count flex--item d-flex fd-column ai-center fc-black-500 fs-title" itemprop="upvoteCount" data-value="1874">
                {object.upVotes}
            </div>
            ...
            <div id="--stacks-s-tooltip-0bkl8i4o" class="s-popover s-popover__tooltip pe-none" aria-hidden="true" role="tooltip">The question owner accepted this as the best answer Apr 9, 2016 at 18:26.<div class="s-popover--arrow"></div>
            </div>

        </div>
        }
        { typeof(object)=="undefined" && <p>Object not found</p> }
        </div>
    );
